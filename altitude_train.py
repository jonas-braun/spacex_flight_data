...
labels_dict = {}
with open(os.path.join(model_folder, 'altitude_training_labels')) as f:
...
folder = os.path.join(model_folder, 'altitude_training')
...
np.save(os.path.join(model_folder, 'altitude_samples.npy'), samples)
np.save(os.path.join(model_folder, 'altitude_labels.npy'), labels)
