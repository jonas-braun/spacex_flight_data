...
class Velocity():
    ...
    def __init__(self):
        ...
        self.samples = np.load(os.path.join(self.model_path, 'velocity_samples.npy'))
        self.labels = np.load(os.path.join(self.model_path, 'velocity_labels.npy'))
...
if __name__ == '__main__':
    ...
    samples = np.load('velocity_samples.npy')
    labels = np.load('velocity_labels.npy')
